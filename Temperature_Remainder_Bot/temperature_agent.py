...
for _ in range(num_cities):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={selected_location}&appid=d1845658f92b31c64bd94f06f7188c9c' 
    try:
...
#here you have to enter your api key code
# CALLMEBOT_API_KEY = 'Telegram_username' 
